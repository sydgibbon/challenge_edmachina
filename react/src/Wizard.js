...
import LeadFormFrame from './LeadFormFrame';

const steps = ['Registra tus datos', 'Selecciona tu materia', 'Revisa tu information'];
              ...
              {activeStep === steps.length ? (
                <Stack spacing={2} useFlexGap>
                  ...
                  <Typography variant="body1" sx={{ color: 'text.secondary' }}>
                    Tu ID de alumno es
                    <strong>&nbsp;#140396</strong>. Todavía quedan muchas cosas por mejorar tanto en front como en back pero creo que lo postulado demuestra mi conocimiento general. Saludos!
                  </Typography>
                  <Button
